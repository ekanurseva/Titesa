    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md mt-3">
                    <div class="mb-4">
                      <label for="rolename" class="form-label">13. Saya sering gugup dan tertekan ketika melakukan
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">14. Saya sering mengumpat ketika mendapat tugas kuliah
                        yang sulit?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">15. Saya sering menyalahkan diri sendiri akibat
                        menundan-nunda tugas perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">16. Saya menangis dan berteriak Ketika mendapat tugas
                        kuliah?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">17. Saya berdiam diri Ketika mendapat tugas perkuliahan?
                      </label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">18. Saya tidak pernah membuat jadwal dan mengabaikan
                        perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">19. Saya merasa jantung berdebar-debar ketika hendak
                        menyelesaikan tugas perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">20. Saya sering pusing ketika mengerjakan tugas
                        perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">21. Saya sering sakit perut ketika mengerjakan kegiatan
                        perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">22. Saya mengalami kerontokan rambut yang parah ketika
                        mendapat banyak tugas perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">23. Saya merasa mual tanpa sebab ketika mengerjakan tugas
                        perkuliahan?</label>
                      <div class="form-check">
                    ...
                    <div class="mb-4">
                      <label for="rolename" class="form-label">24. Timbul jerawat ketika saya mengerjakan tugas
                        perkuliahan?</label>
                      <div class="form-check">
          ...
          <a href="tes.php" class="btn btn-secondary w-100 py-8 fs-4 mb-4 rounded-2">
            < Sebelumnya</a>
