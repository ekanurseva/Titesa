          ...
          <div class="card-body">
            ...
            <form action="" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nama" value="<?= $data['nama']; ?>" class="form-control" id="exampleInputtext1"
              ...
              <div class="mb-4">
                ...
                <input type="password" name="pwd" value="<?= $data['password']; ?>" class="form-control"
                  id="exampleInputPassword1">
              </div>
              <div class="mb-4">
                <label for="exampleInputPassword1" class="form-label">Konfirmasi Password</label>
                <input type="password" name="pwd2" value="<?= $data['password']; ?>" class="form-control"
                  id="exampleInputPassword1">
              </div>
              <div class="mb-4">
              ...
              <div class="input-group mt-2">
                <div class="form-check me-5">
                  <input class="form-check-input" type="radio" name="level" id="level" value="User" <?php if ($data['level'] === 'User') {
                    echo 'checked';
                  } ?>>
                  <label class="form-check-label" for="user">User</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="level" id="level" value="Admin" <?php if ($data['level'] === 'Admin') {
                    echo 'checked';
                  } ?>>
