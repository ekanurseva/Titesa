...
$idjawaban = $_GET['id'];
$jawaban = query("SELECT * FROM jawaban WHERE idjawaban = $idjawaban")[0];
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title fw-semibold mb-4">Data Jawaban</h1>
                        <form action="" method="post">
                            <input type="hidden" name="idjawaban" value="<?= $jawaban['idjawaban']; ?>">

                            <div class="mb-3">
                            <label for="exampleInputtext1" class="form-label">Kode Jawaban :</label>
                            <input type="text" name="kode" class="form-control"
                                value="<?= $jawaban['kode_jawaban'] ?>" id="exampleInputtext1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputtext1" class="form-label">Jawaban :</label>
                                <input type="text" name="jawaban" value="<?= $jawaban['jawaban']; ?>"
                                class="form-control" id="exampleInputtext1">
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputtext1" class="form-label">Bobot :</label>
                                <input type="text" name="bobot" class="form-control"
                                    value="<?= $jawaban['bobot'] ?>" id="exampleInputtext1">
                            </div>

                            <button type="submit" name="edit_jawaban"
