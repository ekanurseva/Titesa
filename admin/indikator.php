  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h1 class="card-title fw-semibold mb-4">Indikator</h1>
                  ...
                  <form action="" method="post">
                    ...
                    <div class="modal-body">
                      ...
                      <select class="form-select" id="kriteria" aria-label="Default select example" name="kriteria">
                        <option selected hidden value="">-- Pilih Kriteria --</option>
                        <?php foreach ($kriteria as $k): ?>
                          <option value="<?= $k['idkarakteristik']; ?>"><?= $k['karakteristik']; ?></option>
                        <?php endforeach; ?>
                      </select>
                      <br>
                      <label for="indikator">Kode Indiator :</label>
                      <input class="form-control" rows="2" id="indikator" name="kode" value="<?= $kode; ?>" readonly>
                      <br>
                      <label for="indikator">Indikator :</label>
                      <textarea class="form-control" rows="2" id="indikator" name="indikator"></textarea>
            ...
            <table class="table">
              ...
              <tbody>
                <?php foreach ($indikator as $i): ?>
                  <tr>
                    <?php
                    $idkriteria = $i['idkarakteristik'];
                    $karakteristik = query("SELECT karakteristik FROM karakteristik WHERE idkarakteristik = $idkriteria")[0];
                    ?>
                    <td>
                    ...
                    <td>
                      <a style="text-decoration: none;" href="editindikator.php?id=<?= $i['idindikator']; ?>">
                        <i class="ti ti-pencil fs-6"></i>
                      </a>
                      |
                      <a style="text-decoration: none;" href="delete_indikator.php?id=<?= $i['idindikator']; ?>"
